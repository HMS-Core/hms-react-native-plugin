...
public class HMSModelDownload extends HMSBase implements MLModelDownloadListener {
    ...
    public void downloadModel(ReadableMap modelConfig, ReadableMap strategyConfig, final Promise promise) {
        ...
        MLLocalModelManager.getInstance().downloadModel(remoteModel,
                HMSObjectCreator.getInstance().createModelDownloadStrategy(strategyConfig), this)
    ...
    public void deleteModel(ReadableMap modelConfig, final Promise promise) {
        ...
        MLLocalModelManager.getInstance().deleteModel(remoteModel)
    ...
    public void isModelExist(ReadableMap modelConfig, final Promise promise) {
        ...
        MLLocalModelManager.getInstance().isModelExist(remoteModel)
                .addOnSuccessListener(aBoolean -> handleResult("isModelExists", HMSResultCreator.getInstance().getBooleanResult(aBoolean), promise))
    ...
    public void getRecentModelFile(final ReadableMap modelConfig, final Promise promise) {
        ...
        MLLocalModelManager.getInstance().getRecentModelFile(remoteModel)
                .addOnSuccessListener(file -> handleResult("getRecentModelFile", HMSResultCreator.getInstance().getFilePathResult(file), promise))
    ...
    private <T extends MLRemoteModel> void handleGetModels(Task<Set<T>> task, Promise promise) {
        task.addOnSuccessListener(models -> handleResult("getModels", HMSResultCreator.getInstance().getModels((Set<MLRemoteModel>) models), promise))
                .addOnFailureListener(e -> handleResult("getModels", e, promise));
    }
}
