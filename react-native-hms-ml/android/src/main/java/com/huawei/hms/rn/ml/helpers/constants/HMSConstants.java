...
public final class HMSConstants {
    ...
    public static final Map<String, Object> DOCUMENT_RECOGNITION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
            putAll(BASE_LANGUAGES);
            putAll(EXTRA_LANGUAGES);
            putAll(BORDER_TYPE);
    ...
    public static final Map<String, Object> BCR_PLUGIN_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
            ...
            put("ERROR_CODE_INIT_CAMERA_FAILED", MLBcrCaptureConfig.ERROR_CODE_INIT_CAMERA_FAILD);
    ...
    public static final Map<String, Object> LANGUAGE_DETECTION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
    ...
    public static final Map<String, Object> SOUND_DETECT_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
            put("SOUND_DETECT_ERROR_AUDIO", MLSoundDectConstants.SOUND_DECT_ERROR_AUDIO);
            put("SOUND_DETECT_ERROR_FATAL_ERROR", MLSoundDectConstants.SOUND_DECT_ERROR_FATAL_ERROR);
            put("SOUND_DETECT_ERROR_NO_MEM", MLSoundDectConstants.SOUND_DECT_ERROR_NO_MEM);
            put("SOUND_DETECT_ERROR_INTERNAL", MLSoundDectConstants.SOUND_DECT_ERROR_INTERNAL);
            put("SOUND_EVENT_TYPE_ALARM", MLSoundDectConstants.SOUND_EVENT_TYPE_ALARM);
            put("SOUND_EVENT_TYPE_BABY_CRY", MLSoundDectConstants.SOUND_EVENT_TYPE_BABY_CRY);
            put("SOUND_EVENT_TYPE_BARK", MLSoundDectConstants.SOUND_EVENT_TYPE_BARK);
            put("SOUND_EVENT_TYPE_CAR_ALARM", MLSoundDectConstants.SOUND_EVENT_TYPE_CAR_ALARM);
            put("SOUND_EVENT_TYPE_DOOR_BELL", MLSoundDectConstants.SOUND_EVENT_TYPE_DOOR_BELL);
            put("SOUND_EVENT_TYPE_KNOCK", MLSoundDectConstants.SOUND_EVENT_TYPE_KNOCK);
            put("SOUND_EVENT_TYPE_LAUGHTER", MLSoundDectConstants.SOUND_EVENT_TYPE_LAUGHTER);
            put("SOUND_EVENT_TYPE_MEOW", MLSoundDectConstants.SOUND_EVENT_TYPE_MEOW);
            put("SOUND_EVENT_TYPE_SCREAMING", MLSoundDectConstants.SOUND_EVENT_TYPE_SCREAMING);
            put("SOUND_EVENT_TYPE_SNEEZE", MLSoundDectConstants.SOUND_EVENT_TYPE_SNEEZE);
            put("SOUND_EVENT_TYPE_SNORING", MLSoundDectConstants.SOUND_EVENT_TYPE_SNORING);
            put("SOUND_EVENT_TYPE_STEAM_WHISTLE", MLSoundDectConstants.SOUND_EVENT_TYPE_STEAM_WHISTLE);
            put("SOUND_EVENT_TYPE_WATER", MLSoundDectConstants.SOUND_EVENT_TYPE_WATER);
    ...
    public static final Map<String, Object> OBJECT_RECOGNITION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
    ...
    public static final Map<String, Object> LANDMARK_RECOGNITION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
    ...
    public static final Map<String, Object> PRODUCT_VISION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
            put("REGION_DR_CHINA", MLRemoteProductVisionSearchAnalyzerSetting.REGION_DR_CHINA);
            put("REGION_DR_SIANGAPORE", MLRemoteProductVisionSearchAnalyzerSetting.REGION_DR_SIANGAPORE);
    ...
    public static final Map<String, Object> IMAGE_RESOLUTION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
    ...
    public static final Map<String, Object> DSC_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
            put("CORRECTION_FAILED", MLDocumentSkewCorrectionConstant.CORRECTION_FAILD);
            put("DETECT_FAILED", MLDocumentSkewCorrectionConstant.DETECT_FAILD);
    ...
    public static final Map<String, Object> FACE_RECOGNITION_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
    ...
    public static final Map<String, Object> MODEL_DOWNLOAD_CONSTANTS = ImmutableMap.copyOf(new HashMap<String, Object>() {
        {
