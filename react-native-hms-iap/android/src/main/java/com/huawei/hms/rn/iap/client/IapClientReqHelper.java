...
import static com.huawei.hms.rn.iap.client.MapUtil.fromJson;
import static com.huawei.hms.rn.iap.client.MapUtil.toArrayList;
import static com.huawei.hms.rn.iap.client.MapUtil.toJson;
import static com.huawei.hms.rn.iap.client.MapUtil.toStringArrayList;

/**
 * IapClientReqHelper is the tool class of {@link IapClientReqPresenter}.
 *
 * @since v.5.0.0
 */

public class IapClientReqHelper {

    private final static String TAG = IapClientReqHelper.class.getSimpleName();

    /**
     * Converts ReadableMap to a
     * requested generic IAP instance(ProductInfoReq, PurchaseIntentReq, PurchaseIntentReq, ConsumeOwnedPurchaseReq, StartIapActivityReq).
     *
