...
@interface RCT_EXTERN_MODULE(HmsAnalytics, NSObject)

RCT_EXTERN_METHOD(config: (RCTPromiseResolveBlock)resolve
...
RCT_EXTERN_METHOD(userProfiles: (BOOL*)predefined resolve:(RCTPromiseResolveBlock)resolve
                  rejecter: (RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(setAnalyticsEnabled: (BOOL*)enabled resolve:(RCTPromiseResolveBlock)resolve
                  rejecter: (RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(aaid: (RCTPromiseResolveBlock)resolve
                  rejecter: (RCTPromiseRejectBlock)reject)
