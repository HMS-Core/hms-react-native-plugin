...
class HmsAnalytics: NSObject, Handling{
  ...
  /// - Returns: Void
  @objc func config(_ resolve: @escaping RCTPromiseResolveBlock,rejecter reject: RCTPromiseRejectBlock) -> Void {
    Log.debug(#function) {
      viewModel.config()
  ...
  @objc func userProfiles(_ predefined: Bool, resolve: @escaping RCTPromiseResolveBlock, rejecter reject: RCTPromiseRejectBlock) -> Void {
    Log.debug(#function) {
  ...
  ///   - reject:  Refers to promise value, in the failure scenarario, exception is returned.
  /// - Returns: Void
  @objc func aaid(_ resolve: RCTPromiseResolveBlock,rejecter reject: RCTPromiseRejectBlock) -> Void {
    Log.debug(#function) {
  ...
  @objc func constantsToExport() -> NSObject {
    var constantTypes = [String : String]()
    addReportPolicies(to: &constantTypes)
    return constantTypes as NSObject
  }

  private func addReportPolicies(to constantTypes: inout [String : String]){
    constantTypes["onScheduledTimePolicy"] = ReportPolicyType.scheduledTime.rawValue
    constantTypes["onAppLaunchPolicy"] = ReportPolicyType.appLaunch.rawValue
    constantTypes["onMoveBackgroundPolicy"] = ReportPolicyType.moveBackground.rawValue
    constantTypes["onCacheThresholdPolicy"] = ReportPolicyType.cacheThreshold.rawValue
  }
