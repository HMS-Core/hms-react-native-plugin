...
public class ActivityUtils {
    public static final Mapper<JSONObject, ActivityConversionInfo> FROM_JSON_OBJECT_TO_ACTIVITY_CONVERSION_INFO =
            mapperWrapper((JSONObject jo) -> new ActivityConversionInfo.Builder()
                    .setConversionType(jo.getInt("conversionType"))
                    .setActivityType(jo.getInt("activityType"))
                    .build());

    public static final Mapper<ActivityIdentificationData, JSONObject> FROM_ACTIVITY_IDENTIFICATION_DATA_TO_JSON_OBJECT =
            mapperWrapper((ActivityIdentificationData obj) -> new JSONObject()
    ...
    private static final Mapper<ActivityConversionData, JSONObject> FROM_ACTIVITY_CONVERSION_DATA_TO_JSON_OBJECT =
            mapperWrapper((ActivityConversionData obj) -> new JSONObject()
                    .put("activityType", obj.getActivityType())
    ...
    public static final Mapper<JSONArray, ActivityConversionRequest> FROM_JSON_ARRAY_TO_ACTIVITY_CONVERSION_REQUEST =
            mapperWrapper((JSONArray ja) -> new ActivityConversionRequest(PlatformUtils.mapJSONArray(ja,
                    ActivityUtils.FROM_JSON_OBJECT_TO_ACTIVITY_CONVERSION_INFO)));

    public static final Mapper<ActivityIdentificationResponse, JSONObject> FROM_ACTIVITY_IDENTIFICATION_RESPONSE_TO_JSON_OBJECT =
            mapperWrapper((ActivityIdentificationResponse response) -> new JSONObject()
                    .put("elapsedTimeFromReboot", (double) response.getElapsedTimeFromReboot())
                    ...
                    .put("activityIdentificationDatas",
                            PlatformUtils.mapList(response.getActivityIdentificationDatas(),
