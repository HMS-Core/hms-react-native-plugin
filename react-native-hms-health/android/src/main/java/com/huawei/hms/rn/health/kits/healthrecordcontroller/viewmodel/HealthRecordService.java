...
public interface HealthRecordService {
     ...
     */
    void addHealthRecord(final HealthRecordController healthRecordController, final HealthRecord healthRecord, final ResultHelper resultHelper);
     ...
     */
    void updateHealthRecord(final HealthRecordController healthRecordController, final HealthRecord healthRecord , final VoidResultHelper resultHelper);
     ...
     * @param resultHelper              {@link ResultHelper} instance.
     */
    void getHealthRecord(final HealthRecordController healthRecordController, final HealthRecordReadOptions healthRecordReadOptions, final ResultHelper resultHelper);
}
